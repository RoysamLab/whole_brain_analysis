...
def MergeUpdatedBboxs(xml_dir, output_file):
    ...
    # bbxs = np.array(bbxs) + [16000, 8000, 16000, 8000]
    bbxs = np.array(bbxs)
    # get centers
...
if __name__ == "__main__":
    ...
    parser.add_argument('--xml_dir', type=str, default='data/train/16000_8000/temp', help='path to the directory of xml files')
    parser.add_argument('--output_file', type=str, default='data/train/16000_8000/merged.txt', help='path to the output file name')
