    ...
    for fileName in allFileNames:
        if len(fileName.split('.')) >1 : # not folder
            ...
            #            DAPI_masks_fileNames.append(fileName)
                elif ('FeatureTable' in fileName) and (  ('FCS' in fileName) == False ) and ( (  ('origin' in fileName) == False )):
...
#    
    ...
    #    print(actualImageNames)
        ...
        #    Mask.set('biomarker',actualImageName.split('_')[0]) 
            ...
            if biomarkerName == '[DAPI+Histones]':                                            # nuclues Mask, generate for all channels
...
#        #
        ...
        xml_fileName = 'CHN50_FeatureTableOnly.ice'
