...
def _parse_requirements(file_path):
    pip_ver = pkg_resources.get_distribution('pip3.6').version
...
try:
    # install_reqs = _parse_requirements("requirements_gpu.txt")
    install_reqs = _parse_requirements("requirements_cpu.txt")
