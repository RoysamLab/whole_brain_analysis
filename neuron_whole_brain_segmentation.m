function [] = neuron_whole_brain_segmentation(varargin)
    ...
    for i=1: length(xc)
        ...
        if neun_val==1
            ...
            neuron_results(i).index=i;
            neuron_results(i).cell_type=0; %Astrocyte, S100 is astrocyte pan-specific
            ...
            neuron_results(i).nucleus_img = seg_masks_props(row).Image;
            neuron_results(i).x1 = x1;
            neuron_results(i).x2 = x2;
            neuron_results(i).y1 = y1;
            neuron_results(i).y2 = y2;
            neuron_results(i).x_c=x_c;
            neuron_results(i).y_c=y_c;
            ...
            neuron_results(i).soma_x1=x_c-half_w_p+ceil(soma_BB(1));
            neuron_results(i).soma_x2=x_c-half_w_p+soma_BB(3)-1+ceil(soma_BB(1));

            neuron_results(i).soma_y1=y_c-half_w_p+ceil(soma_BB(2));
            neuron_results(i).soma_y2=y_c-half_w_p+soma_BB(4)-1+ceil(soma_BB(2));

            neuron_results(i).soma_img=imcrop(soma_mask,[ceil(soma_BB(1)),ceil(soma_BB(2)),soma_BB(3)-1,soma_BB(4)-1]);
            ...
            neuron_results(i).cell_x1=x_c-half_w_p+ceil(whole_cell_BB(1));
            neuron_results(i).cell_x2=x_c-half_w_p+ceil(whole_cell_BB(1))+whole_cell_BB(3)-1;

            neuron_results(i).cell_y1=y_c-half_w_p+ceil(whole_cell_BB(2));
            neuron_results(i).cell_y2=y_c-half_w_p+ceil(whole_cell_BB(2))+whole_cell_BB(4)-1;

            neuron_results(i).cell_img=imcrop(whole_cell,[ceil(whole_cell_BB(1)),ceil(whole_cell_BB(2)),whole_cell_BB(3)-1,whole_cell_BB(4)-1]);
            neuron_results(i).processes_img=imcrop(processes,[ceil(whole_cell_BB(1)),ceil(whole_cell_BB(2)),whole_cell_BB(3)-1,whole_cell_BB(4)-1]);
            neuron_results(i).cytoplasm_img=imcrop(cytoplasm,[ceil(whole_cell_BB(1)),ceil(whole_cell_BB(2)),whole_cell_BB(3)-1,whole_cell_BB(4)-1]);
            neuron_results(i).membrane_img=imcrop(membrane,[ceil(whole_cell_BB(1)),ceil(whole_cell_BB(2)),whole_cell_BB(3)-1,whole_cell_BB(4)-1]);
            ...
            all_neuron_nucleus(neuron_results(i).y1:neuron_results(i).y2,neuron_results(i).x1:neuron_results(i).x2)=neuron_results(i).nucleus_img+all_neuron_nucleus(neuron_results(i).y1:neuron_results(i).y2,neuron_results(i).x1:neuron_results(i).x2);
            all_neuron_soma(neuron_results(i).soma_y1:neuron_results(i).soma_y2,neuron_results(i).soma_x1:neuron_results(i).soma_x2)=neuron_results(i).soma_img+all_neuron_soma(neuron_results(i).soma_y1:neuron_results(i).soma_y2,neuron_results(i).soma_x1:neuron_results(i).soma_x2);
            all_neuron_whole_cell(neuron_results(i).cell_y1:neuron_results(i).cell_y2,neuron_results(i).cell_x1:neuron_results(i).cell_x2)=neuron_results(i).cell_img+all_neuron_whole_cell(neuron_results(i).cell_y1:neuron_results(i).cell_y2,neuron_results(i).cell_x1:neuron_results(i).cell_x2);
            all_neuron_processes(neuron_results(i).cell_y1:neuron_results(i).cell_y2,neuron_results(i).cell_x1:neuron_results(i).cell_x2)=neuron_results(i).processes_img+all_neuron_processes(neuron_results(i).cell_y1:neuron_results(i).cell_y2,neuron_results(i).cell_x1:neuron_results(i).cell_x2);
            all_neuron_cytoplasm(neuron_results(i).cell_y1:neuron_results(i).cell_y2,neuron_results(i).cell_x1:neuron_results(i).cell_x2)=neuron_results(i).cytoplasm_img+all_neuron_cytoplasm(neuron_results(i).cell_y1:neuron_results(i).cell_y2,neuron_results(i).cell_x1:neuron_results(i).cell_x2);
            all_neuron_membrane(neuron_results(i).cell_y1:neuron_results(i).cell_y2,neuron_results(i).cell_x1:neuron_results(i).cell_x2)=neuron_results(i).membrane_img+all_neuron_membrane(neuron_results(i).cell_y1:neuron_results(i).cell_y2,neuron_results(i).cell_x1:neuron_results(i).cell_x2);
        end
    ...
    save(fullfile(p.Results.OUTPUT_DIR,'neuron_reconstruction_info.mat'),'neuron_results');
end
